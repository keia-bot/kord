 ...
 */
private data class XSalsa20Poly1305Impl(val nonceStrategyFactory: NonceStrategy.Factory) : VoiceEncryption {
    ...
    sealed class Impl(protected val nonceStrategyFactory: NonceStrategy.Factory) {
