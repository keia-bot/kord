...
@JvmInline
public value class Activity(public val data: ActivityData) {
    ...
    public val start: Instant?
        get() = data.timestamps.value?.start?.value

    public val end: Instant?
        get() = data.timestamps.value?.end?.value

    public val applicationId: Snowflake?
        get() = data.applicationId.value

    public val details: String?
        get() = data.details.value

    public val emoji: DiscordActivityEmoji?
        get() = data.emoji.value

    public val state: String?
        get() = data.state.value
